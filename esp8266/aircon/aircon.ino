...
void mqtt_int(String sub1, int param) {
  String subs = String("smartthings/airconditioner/") + hostname + "/" + sub1;
  char val[10] = {0};
  itoa(param, val, 10);
...
int modetoint( char *msg) {
  ...
  if (strcmp(msg, "dryair") == 0) retint = 68;
  if (strcmp(msg, "fanonly") == 0) retint = 69;
  if (strcmp(msg, "off") == 0) retint = -1;
...
String inttomode (byte val) {
  ...
  if (val == 68) reply = "dryair";
  if (val == 69) reply = "fanonly";
  return reply;
}
...
int fanmodetoint(char *msg) {
  ...
  if (strcmp(msg, "1") == 0) retint = 50;
  if (strcmp(msg, "2") == 0) retint = 51;
  if (strcmp(msg, "3") == 0) retint = 52;
  if (strcmp(msg, "4") == 0) retint = 53;
  if (strcmp(msg, "5") == 0) retint = 54;
  if (strcmp(msg, "auto") == 0) retint = 65;
  return retint;
}
...
void modeControl(char message[]) {
  ...
  if (function_value == 0) return;

  if (function_value == -1) {
    send_code(128, 49, 52); // off
  } else {
    send_code(128, 48, 52); // on
    send_code(176, function_value, 4);
  }
}
...
void stateControl(char message[]) {
  ...
  send_code(128, function_value, 52);
}
